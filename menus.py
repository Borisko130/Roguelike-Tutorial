...
def inventory_menu(con, header, player, inventory_width, screen_width, screen_height):
    ...
    if len(player.inventory.items) == 0:
        ...
        # Checks and prints if item is equipped
...
def main_menu(con, background_image, screen_width, screen_height):
    ...
    libtcod.console_print_ex(0, int(screen_width / 2), int(screen_height / 2) - 4, libtcod.BKGND_NONE, libtcod.CENTER, 'SUPERGAME')
    libtcod.console_print_ex(0, int(screen_width / 2), int(screen_height - 2), libtcod.BKGND_NONE, libtcod.CENTER, 'By Boris')
