...
"""
Actions which can be performed by items
"""

# Heals entity which uses item by amount
...
# Zaps lightning from caster to entity
def cast_lightning(*args, **kwargs):
    ...
    if target:
        ...
        results.append({'consumed': False, 'target': None, 'message': Message('No enemy os close enough to strike.', libtcod.red)})
