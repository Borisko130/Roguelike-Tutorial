...
def main():
    ...
    con = libtcod.console_new(constants['screen_width'], constants['screen_height'])  #Game screen
    panel = libtcod.console_new(constants['screen_height'], constants['panel_height']) #UI panel
